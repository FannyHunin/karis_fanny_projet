...
<div class="container mt-5">
    <div class="card border-dark mt-5 mb-5 pt-2 pb-2" style="width: 22rem;">
        <div class="card-body">
            ...
            <h5 class="card-title font-weight-bolder text-primary">Email : {{$showJoueur->email}}</h5>

            <div class="mt-4">
                <button class="btn btn-success">Voir l'Équipe</button>
